...
class TestPlanningEngine:
    ...
    def test_analyze_specification_success(
        self, mock_model_router, sample_specification, sample_analysis_response
    ):
    ...
    def test_analyze_specification_json_error(
        self, mock_model_router, sample_specification
    ):
    ...
    def test_create_test_plan_success(
        self,
        mock_model_router,
        sample_specification,
        sample_analysis_response,
        sample_test_plan_response,
    ):
        ...
        mock_model_router.generate_response.side_effect = [
            analysis_response,
            plan_response,
        ]
