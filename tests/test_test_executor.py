...
from orchestrator.mcp.playwright_client import PlaywrightMCPClient, BrowserMode, TestResult
...
class TestTestExecutor:
    ...
    async def test_execute_test_with_command_line_args(self, test_executor, sample_test_file):
    ...
    async def test_execute_test_playwright_unavailable(self, test_executor, sample_test_file):
    ...
    async def test_execute_test_playwright_failure(self, test_executor, sample_test_file):
...
class TestEnvironmentDetection:
    ...
    def test_ci_environment_detection(self, temp_config, mock_playwright_client, mock_artifact_manager):
    ...
    def test_development_environment_detection(self, temp_config, mock_playwright_client, mock_artifact_manager):
    ...
    def test_environment_variable_override_precedence(self, temp_config, mock_playwright_client, mock_artifact_manager):
    ...
    def test_command_line_flag_highest_precedence(self, temp_config, mock_playwright_client, mock_artifact_manager):
