...
class TestArtifactManager:
    ...
    def test_get_expired_artifacts_default_retention(
        self, artifact_manager, sample_artifact_file
    ):
    ...
    def test_get_expired_artifacts_ci_retention(
        self, artifact_manager, sample_artifact_file
    ):
    ...
    def test_get_expired_artifacts_custom_retention(
        self, artifact_manager, sample_artifact_file
    ):
    ...
    @pytest.mark.asyncio
    async def test_cleanup_expired_artifacts_dry_run(
        self, artifact_manager, sample_artifact_file
    ):
    ...
    @pytest.mark.asyncio
    async def test_cleanup_expired_artifacts_actual(
        self, artifact_manager, temp_config
    ):
    ...
    @pytest.mark.asyncio
    async def test_cleanup_no_expired_artifacts(
        self, artifact_manager, sample_artifact_file
    ):
    ...
    def test_storage_statistics(self, artifact_manager, sample_artifact_file):
        ...
        assert (
            stats["retention_days"] == artifact_manager.config.artifact_retention_days
        )
    ...
    def test_registry_persistence(self, temp_config):
        ...
        assert (
            manager2._artifact_registry[artifact_id].artifact_type
