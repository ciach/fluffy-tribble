...
class TestModelRouter:
    ...
    @patch("orchestrator.models.router.OpenAI")
    @pytest.mark.asyncio
    async def test_call_openai_model(
        self, mock_openai_class, mock_config, mock_openai_client
    ):
    ...
    @pytest.mark.asyncio
    async def test_call_ollama_model(
        self, mock_litellm, mock_openai_class, mock_config, mock_litellm_response
    ):
    ...
    @patch("orchestrator.models.router.OpenAI")
    @pytest.mark.asyncio
    async def test_route_task_planning(
        self, mock_openai_class, mock_config, mock_openai_client
    ):
    ...
    @patch("orchestrator.models.router.litellm.acompletion")
    @pytest.mark.asyncio
    async def test_route_task_drafting(
        self, mock_litellm, mock_openai_class, mock_config, mock_litellm_response
    ):
    ...
    @patch("orchestrator.models.router.OpenAI")
    @pytest.mark.asyncio
    async def test_route_task_with_fallback(
        self, mock_openai_class, mock_config, mock_openai_client
    ):
        ...
        mock_openai_client.chat.completions.create.side_effect = [
            ...
            Mock(
                choices=[Mock(message=Mock(content="Fallback response"))],
