...
from orchestrator.core.exceptions import FileOperationError, ValidationError, MCPConnectionError
from orchestrator.mcp.models import FileOperationRequest, FileOperationResult, ValidationResult
...
class TestFilesystemMCPClient:
    ...
    @pytest.mark.asyncio
    async def test_read_file_success(self, filesystem_client, temp_e2e_dir, mock_connection_manager):
        ...
        mock_connection_manager.call_tool.assert_called_once_with(
            "filesystem",
            "read_file",
            {"path": str(temp_e2e_dir / "test.spec.ts")}
        )

    @pytest.mark.asyncio
    async def test_read_file_invalid_path(self, filesystem_client, mock_connection_manager):
    ...
    @pytest.mark.asyncio
    async def test_read_file_mcp_error(self, filesystem_client, mock_connection_manager):
    ...
    @pytest.mark.asyncio
    async def test_write_file_success(self, filesystem_client, temp_e2e_dir, mock_connection_manager):
    ...
    @pytest.mark.asyncio
    async def test_write_file_with_backup(self, filesystem_client, temp_e2e_dir, mock_connection_manager):
    ...
    @pytest.mark.asyncio
    async def test_write_file_invalid_path(self, filesystem_client, mock_connection_manager):
        """Test writing file with invalid path."""
        result = await filesystem_client.write_file("../../../etc/passwd", "malicious content")
    ...
    @pytest.mark.asyncio
    async def test_delete_file_success(self, filesystem_client, temp_e2e_dir, mock_connection_manager):
    ...
    @pytest.mark.asyncio
    async def test_delete_file_with_backup(self, filesystem_client, temp_e2e_dir, mock_connection_manager):
    ...
    @pytest.mark.asyncio
    async def test_list_files_success(self, filesystem_client, temp_e2e_dir, mock_connection_manager):
    ...
    @pytest.mark.asyncio
    async def test_list_files_recursive(self, filesystem_client, temp_e2e_dir, mock_connection_manager):
    ...
    @pytest.mark.asyncio
    async def test_create_directory_success(self, filesystem_client, temp_e2e_dir, mock_connection_manager):
        ...
        mock_connection_manager.call_tool.assert_called_once_with(
            ...
            "create_directory",
            {
                "path": str(temp_e2e_dir / "new_pages"),
                "parents": True
            }
        )

    @pytest.mark.asyncio
    async def test_create_directory_nested(self, filesystem_client, temp_e2e_dir, mock_connection_manager):
    ...
    @pytest.mark.asyncio
    async def test_file_exists_true(self, filesystem_client, temp_e2e_dir, mock_connection_manager):
    ...
    @pytest.mark.asyncio
    async def test_file_exists_false(self, filesystem_client, temp_e2e_dir, mock_connection_manager):
    ...
    @pytest.mark.asyncio
    async def test_get_file_info(self, filesystem_client, temp_e2e_dir, mock_connection_manager):
    ...
    def test_validate_server_configuration(self, filesystem_client, mock_connection_manager):
