...
def log_mcp_call(logger: logging.Logger, server: str, method: str, duration: float, success: bool, **metadata):
    """
...
def log_model_call(logger: logging.Logger, model: str, task_type: str, duration: float, success: bool, **metadata):
    """
