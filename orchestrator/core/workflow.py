...
class WorkflowManager:
    ...
    def start_workflow(self, metadata: Optional[Dict[str, Any]] = None) -> WorkflowContext:
        """
    ...
    def end_workflow(self, success: bool = True, error: Optional[Exception] = None) -> None:
        """
    ...
    def update_metadata(self, **metadata) -> None:
        ...
        if self._current_workflow:
            ...
            self.logger.warning("Attempted to update workflow metadata but no workflow is active")
