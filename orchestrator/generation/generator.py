...
class TestGenerator:
    ...
    def __init__(self, model_router: ModelRouter, selector_auditor: Optional[SelectorAuditor] = None):
...
"""
    ...
    def generate_test(self, test_plan: TestPlan, file_name: str, 
                     output_dir: str = "e2e") -> GeneratedTest:
        ...
        try:
            ...
            prompt = self._generation_prompts["generate_test"].format(
                test_plan=self._format_test_plan(test_plan),
                file_name=file_name
            )
            ...
            audit_result = self.selector_auditor.audit_test_code(test_content, file_path)
            ...
            logger.info(f"Test generation completed: {file_name} "
    ...
    def update_test(self, existing_test: str, changes: List[str], 
        ...
        try:
            ...
            audit_result = self.selector_auditor.audit_test_code(updated_content, file_path)
    ...
    def scaffold_page_object(self, page_object: PageObject, 
                           output_dir: str = "e2e/pages") -> PageObjectScaffold:
        ...
        try:
            ...
            scaffold = PageObjectScaffold(
                ...
                selectors={sel.element_description: sel.selector for sel in page_object.selectors},
