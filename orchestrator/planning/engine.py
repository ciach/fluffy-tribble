...
from .models import (
    TestSpecification, TestPlan, TestCase, TestStep, 
    Assertion, PageObject, SelectorInfo, TestGapAnalysis, Priority
)
...
"""
    ...
    def create_test_plan(self, specification: TestSpecification) -> TestPlan:
        ...
        try:
            ...
            logger.info(f"Test plan created with {len(test_plan.test_cases)} test cases")
            return test_plan
    ...
    def identify_test_gaps(self, specification: TestSpecification, 
                          existing_tests: List[str]) -> TestGapAnalysis:
        ...
        try:
            ...
            logger.info(f"Gap analysis completed: {len(gap_analysis.missing_test_cases)} missing tests")
            return gap_analysis
    ...
    def _convert_to_test_plan(self, specification_id: str, plan_data: Dict[str, Any]) -> TestPlan:
