...
class ExecutionConfig(BaseModel):
    ...
    screenshot_mode: str = Field("only-on-failure", description="Screenshot collection mode")
...
class ExecutionResult(BaseModel):
    ...
    # Execution context
    execution_config: ExecutionConfig = Field(..., description="Execution configuration used")
    ...
    def validate_status_exit_code(cls, v, values):
        ...
        elif v in [TestStatus.FAILED, TestStatus.ERROR, TestStatus.TIMEOUT] and exit_code == 0:
